...
// service.
func (c *Client) CarbonEmissions(ctx context.Context, p *CarbonPayload) (res []*CarbonForecast, err error) {
	var ires interface{}
...
func (c *Client) AggregateData(ctx context.Context, p *AggregatePayload) (err error) {
